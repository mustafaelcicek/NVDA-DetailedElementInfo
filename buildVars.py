...
addon_info = AddonInfo(
	...
	addon_name="detailedElementInfo",
	# Add-on summary/title, usually the user visible name of the add-on
	# Translators: Summary/title for this add-on
	# to be shown on installation and add-on information found in add-on store
	addon_summary=_("Detailed Element Info"),
	# Add-on description
	# Translators: Long description to be shown for this add-on on add-on information from add-on store
	addon_description=_("""Shows accessibility, ARIA, and DOM details for the focused HTML element on web pages."""),
	# version
	addon_version="1.0.2",
...
"""),
	...
	addon_url="https://github.com/mustafaelcicek/NVDA-DetailedElementInfo",
	# URL for the add-on repository where the source code can be found
	addon_sourceURL="https://github.com/mustafaelcicek/NVDA-DetailedElementInfo",
...
pythonSources: list[str] = ["addon/globalPlugins/detailedElementInfo/*.py"]
